...
export default function ResetPasswordSidebar() {
  return (
    <div className="p-2 hidden h-full lg:block lg:w-95 relative z-10">
      <div className="lg:flex h-full w-full flex-col rounded-lg border bg-card border-border">
        <div className="mb-5 px-5 py-2 border-b border-border/50">
          <Link href="/">
        ...
        <div className="p-5">
          <Link
            href="/login"
            className="w-fit text-xs flex items-center gap-1.5 transition-colors text-muted-foreground hover:text-foreground"
          >
