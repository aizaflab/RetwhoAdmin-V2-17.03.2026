  ...
  (
    ...
    const renderCalendar = (month: Date, panel: "left" | "right") => {
      ...
      return (
        <div className="min-w-0 flex-1">
          ...
          {/* Day names */}
          <div className={cn("mb-1 grid grid-cols-7 gap-0")}>
          ...
          <div
            className={`grid grid-cols-7 gap-0 gap-y-0.5 ${
              gridBox
                ? "dark:border-darkBorder border-t border-l border-border"
                : ""
            }`}
          >
            {days.map((date, idx) => {
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    gridBox &&
                      "dark:border-darkBorder border-r border-b border-border",
    ...
    const renderPopupContent = () => {
      if (variant === "professional") {
        return (
          <div className="dark:bg-darkPrimary dark:border-darkBorder w-88.5 max-w-[95vw] rounded-md border border-gray-200 bg-white shadow-md sm:w-[500px] lg:w-[600px]">
            <div id={gridId} className="flex min-h-84">
              ...
              <div className="flex min-w-0 flex-1 flex-col">
                ...
                <div className="w-full overflow-hidden">
                  ...
                  >
                    <div className="grid min-w-full flex-1 grid-cols-1 gap-3 p-2 lg:grid-cols-2 lg:p-4 lg:pt-5">
      ...
      <div className={cn("relative", fullWidth && "w-full", className)}>
        ...
        <div ref={triggerRefc} className="relative flex items-center">
          <input
            ...
            type="text"
            className={cn(
              "dark:border-darkBorder flex h-10 w-full rounded-md border border-border bg-background px-3 py-2 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 dark:bg-transparent",
          ...
          {startIcon ? (
            <div
              className="pointer-events-none absolute top-1/2 left-3 -translate-y-1/2 text-gray-500 dark:text-gray-300"
              aria-hidden="true"
            >
              {startIcon}
            </div>
            ...
            <div
              className="absolute top-1/2 left-3 -translate-y-1/2 cursor-pointer text-gray-500 dark:text-gray-300"
              onClick={() => !disabled && !readOnly && openPopup()}
              aria-hidden="true"
            >
          ...
          {hasRange && showClearButton && !disabled && !readOnly ? (
            ...
            endIcon && (
              <div
                className="pointer-events-none absolute top-1/2 right-3 -translate-y-1/2 text-gray-500 dark:text-gray-300"
                aria-hidden="true"
              >
                {endIcon}
              </div>
        ...
        {typeof document !== "undefined" &&
          ...
          createPortal(
            <div
              ...
              className={cn(
                "absolute z-50 -mt-0.5 border-none bg-transparent shadow-none transition-all duration-150 ease-in-out",
