...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-[69px] items-center justify-between gap-2 border-b border-gray-200 bg-white/80 backdrop-blur-md px-4 sm:px-6 dark:border-slate-800 dark:bg-black/80 transition-all">
