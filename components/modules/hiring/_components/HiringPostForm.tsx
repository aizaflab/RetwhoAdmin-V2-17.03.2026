...
export default function HiringPostForm({
  ...
  const sectionClass =
    "bg-white dark:bg-darkBg p-4 sm:p-6 rounded-xl border border-border/50 dark:border-darkBorder space-y-4";
  const sectionTitle =
    "text-sm font-semibold text-black dark:text-white flex items-center gap-2 mb-1";
        ...
        <div className="xl:col-span-2 space-y-5">
          ...
          <div className={sectionClass}>
            ...
            <TextEditor
              ...
              placeholder="List all benefits, perks, and what the candidate will gain..."
            />
          </div>
        </div>
        ...
        <div className="space-y-5">
          ...
          <div className={sectionClass}>
            ...
            <div>
              ...
              <input
                ...
                className="w-full h-10 px-3 text-sm rounded-md border border-border dark:border-darkBorder bg-white dark:bg-darkPrimary text-black dark:text-white outline-none focus:border-primary transition-colors"
              />
            </div>
          </div>
          ...
          <div className={sectionClass}>
            ...
            <div
              ...
              className="relative border-2 border-dashed border-border dark:border-darkBorder rounded-xl flex flex-col items-center justify-center cursor-pointer hover:border-primary transition-colors min-h-36 overflow-hidden"
            >
              <input
                type="file"
                ref={logoInputRef}
          ...
          <div className={sectionClass}>
            ...
            <div
              ...
              className="relative border-2 border-dashed border-border dark:border-darkBorder rounded-xl flex flex-col items-center justify-center cursor-pointer hover:border-primary transition-colors min-h-40 overflow-hidden"
            >
              <input
                type="file"
                ref={fileInputRef}
              ...
              {formData.bannerImage ? (
                ...
                <div className="flex flex-col items-center gap-2 text-center p-4">
                  <CloudUploadIcon className="w-8 h-8 text-text5" />
                  <p className="text-xs text-text5">
                    <span className="text-primary">Click to upload</span> banner
                  </p>
                  <p className="text-[10px] text-text5">
