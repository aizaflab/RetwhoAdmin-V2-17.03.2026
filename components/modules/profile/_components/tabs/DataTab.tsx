    ...
    <div className="space-y-8">
      ...
      >
        <div className="space-y-3">
          {[
            ...
            <div
              key={item.label}
              className="flex items-center gap-4 p-4 rounded-lg border border-border/40 hover:border-border/70 transition-colors"
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <button className="px-3 py-1.5 text-xs font-medium rounded-lg border border-border/60 text-foreground hover:border-primary/40 hover:text-primary transition-colors cursor-pointer bg-card">
                  Export
                </button>
              </div>
            </div>
      ...
      >
        <div className="space-y-4 p-4 rounded-lg border border-rose-200/70 dark:border-rose-500/20 bg-rose-50/30 dark:bg-rose-500/5">
          <div className="flex items-start gap-3 p-4 rounded-lg border border-rose-200/50 dark:border-rose-500/20 bg-card">
          ...
          <div className="flex items-start gap-3 p-4 rounded-lg border border-rose-200/50 dark:border-rose-500/20 bg-card">
            ...
            <button className="flex items-center gap-2 px-3 py-2 text-xs font-medium rounded-md bg-destructive text-destructive-foreground hover:bg-destructive/90 transition-colors cursor-pointer shrink-0">
